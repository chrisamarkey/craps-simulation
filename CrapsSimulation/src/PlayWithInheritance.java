...
public class PlayWithInheritance
{
	...
	public static void main(String[] args)
	{
		...
		{
			StdOut.printf("\nThe code is in the OVERRIDING STATIC code section of the PlayWithInteritance class.\n");
			Die die = new Die();
			die.testStatic();
			StdOut.printf("\n<--Check to see if the previous code line prints 'Die.testStatic()' for the Die class.\n");
			die = new CrookedDie1();
			die.testStatic();
			StdOut.printf("\n<--Check to see if the previous code line's call to the CrookedDie1 class's testStatic() method overrides the Die class to print 'CrookedDie1.testStatic()' instead of 'Die.testStatic().\n");
			die = new CrookedDie2();
			die.testStatic();
			StdOut.printf("\n<--Check to see if the previous code line's call to the CrookedDie2 class's testStatic() method overrides the Die class to print 'CrookedDie2.testStatic()' instead of 'Die.testStatic().\n");
			
//			creates a Die instance variable named die, 
//			assigns to die an instance of the subclass CrookedDie1, 
//			then calls die.testStatic().  
//			The returned value indicates the answer to the question.
